...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent('''Example:
            petcat.py -t 192.168.1.108 -p 555 -l -c   # command shell
            petcat.py -t 192.168.1.108 -p 555 -l -u=my.txt  # upload a file
            petcat.py -t 192.168.1.108 -p 555 -l -e="cat /etc/passwd"  # execute a command
            echo 'ABC' | ./petcat.py -t 192.168.1.108 -p 135  # echo text to server
